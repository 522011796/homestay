  ...
  <div>
    ...
    <Modal
      ...
      <Form  ref="ruleForm" label-position="right" :label-width="100" inline style="width: 100%;margin:0 auto;">
        ...
        <!--<div>
          <Checkbox @on-change="selOnlyBox()" v-if="showEditOrder" class="pull-left orderListBox" :data-value="ruleForm.orderId"></Checkbox>
        ...
        <div v-if="ruleForm.relaOrderList.length > 0">
          ...
          <Checkbox @on-change="selOnlyBox()" v-if="showEditOrder" class="pull-left orderListBox" :data-value="ruleForm.orderId"></Checkbox>
          <Card class="orderCard pull-right" v-for="(item,index) in ruleForm.relaOrderList" :key="index" :class="{'w96-full':showEditOrder,'w100-full':!showEditOrder}">
            <div>
              <div>
                <FormItem :label-width="70" label="姓名:" class="margin-bottom0">
                  {{item.real_name}}
